...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL_0.0.4.data';
    var REMOTE_PACKAGE_BASE = 'WebGL_0.0.4.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2661019;
      var PACKAGE_UUID = '0e0ca518-a7c4-4ed9-81cb-6ed237362ee0';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 264876, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(264876, 264897, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(264897, 265646, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(265646, 1758422, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1758422, 2633394, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2633394, 2661019, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL_0.0.4.data');

    };
    Module['addRunDependency']('datafile_WebGL_0.0.4.data');
