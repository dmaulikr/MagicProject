...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGL_0.0.1.data';
    var REMOTE_PACKAGE_BASE = 'WebGL_0.0.1.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2504226;
      var PACKAGE_UUID = 'e931e8c4-808c-42cc-b954-33a5c2849ded';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 138813, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(138813, 138834, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(138834, 138949, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(138949, 1601629, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1601629, 2476601, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2476601, 2504226, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGL_0.0.1.data');

    };
    Module['addRunDependency']('datafile_WebGL_0.0.1.data');
